...
The mods are preconfigured and their keybinds are set to not conflict. You can still configure them, but you most likely don't need to.
...
- [Critters & Companions](https://modrinth.com/mod/critters-and-companions)
...
- [Macaw](https://modrinth.com/user/sketchmacaw)'s mods
...
- [YUNG](https://modrinth.com/user/YUNGNICKYOUNG)'s mods
- [Ribbits](https://modrinth.com/mod/ribbits)

### Utility & miscellaneous

- [Sophisticated Storage](https://modrinth.com/mod/sophisticated-storage-(unofficial-fabric-port))
...
and many more, including optimization and aesthetic mods.
